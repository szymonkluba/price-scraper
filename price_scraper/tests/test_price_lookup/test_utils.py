...
import requests
from apps.price_lookup.price_lookup import NoPageFoundException, LookupWebsite, NoConnectionException, PriceLookup
...
class PriceLookupSelectorsTests(TestCase):
    ...
    def test_finds_value_by_class(self):
        self.website.get_website_as_text = MagicMock(return_value=self.PAGE_PRICE_WITH_CLASS)
    ...
    def test_finds_value_by_id(self):
        self.website.get_website_as_text = MagicMock(return_value=self.PAGE_PRICE_WITH_ID)
        self.search_params.price_class = "#price"
...
class PriceLookupValuesTests(TestCase):
    ...
    def test_non_numeric_values(self):
        self.website.get_website_as_text = MagicMock(return_value=self.PAGE_NO_NUMBERS)
        self.search_params.price_class = "#price"
    ...
    def test_non_numeric_values_in_content(self):
        self.website.get_website_as_text = MagicMock(return_value=self.PAGE_NO_NUMBERS_IN_CONTENT)
        self.search_params.price_class = "#price"
    ...
    def test_values_with_currency(self):
        self.website.get_website_as_text = MagicMock(return_value=self.PAGE_PRICE_WITH_CURRENCY)
        self.search_params.price_class = "#price"
...
class PriceLookupItemAvailabilityTests(TestCase):
    ...
    def test_item_unavailable(self):
        self.website.get_website_as_text = MagicMock(return_value=self.PAGE_ITEM_OUT_OF_STOCK)
