...
class UserManagerTests(TestCase):
    ...
    def test_create_user(self):
        user = CustomUser.objects.create_user(email="test@example.com", password="testPassword")
    ...
    def test_create_superuser(self):
        admin_user = CustomUser.objects.create_superuser(email="test_superuser@example.com", password="testPassword")
